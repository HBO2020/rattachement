...
describe('Rattachement e2e test', () => {
  ...
  describe('new Rattachement page', () => {
    ...
    it('should create an instance of Rattachement', () => {
      ...
      cy.get(`[data-cy="dateCreation"]`).type('2022-06-12T06:27').should('have.value', '2022-06-12T06:27');

      cy.get(`[data-cy="dateMaj"]`).type('2022-06-12T13:41').should('have.value', '2022-06-12T13:41');
